...
class DecayConfig:
    ...
    half_life_days: float = 365.0  # Time for memory strength to decay by 50%
...
class MemoryDecayService:
    ...
    def compute_decay_factor(self, creation_timestamp: int, current_time: float | None = None) -> float:
        """
