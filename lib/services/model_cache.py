...
class ModelCache:
    ...
    def get_cached_models(self, provider: Optional[str] = None) -> List[CachedModel]:
        """
    ...
    def get_model(self, full_model_name: str) -> Optional[CachedModel]:
        """
    ...
    def to_ollama_format(self, provider: Optional[str] = None) -> List[Dict[str, Any]]:
        """
