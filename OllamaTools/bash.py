...
async def bash(client: discord.Client, source_id: str, command: str, close_session: bool = False):
    """
    ...
    try:
        ...
        def run_ssh_command():
            ...
            if source_id not in client.ssh_client:
                ...
                client.ssh_client[source_id] = {
                    "client": ssh_client,
                    "channel": channel,
                    "buffer": ""
                }
            else:
                channel = client.ssh_client[source_id]["channel"]
        ...
        if close_session:
            ...
            await asyncio.to_thread(client.ssh_client[source_id]["client"].close)
            del client.ssh_client[source_id]
