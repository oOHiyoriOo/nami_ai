/**
 * history.js — SQLite-backed per-conversation message history.
 *
...
class ConversationHistory {
   ...
   * @param {string} name      - Display name of the sender or bot
   ...
   * formatted with name and timestamp, ready for the nami_ai /api/chat messages array.
   * @param {string} conversationId
